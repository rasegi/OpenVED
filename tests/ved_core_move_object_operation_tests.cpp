...
int main() {
  {
    ...
    if (int result =
            expect(operationManager.GetAktiveOperationType() == VOM_MOVE_OBJECT, "move operation was not activated")) {
      return result;
    }
    ...
    if (int result = expect(operationManager.GetAktiveOperationType() == VOM_SELECT_MOVE_NODE_OBJECT,
                            "move operation did not return to select-move after mouse up")) {
      return result;
    }
    if (int result =
            expectLine(*line, 10.0, 5.0, 110.0, 5.0, "selected line was not moved from midpoint to release point")) {
      return result;
    }
...

  {
    ...
    if (int result = expect(operationManager.GetAktiveOperationType() == VOM_SELECT_MOVE_NODE_OBJECT,
                            "group move operation did not return to select-move after mouse up")) {
      return result;
    }
