...
int expectHitKind(const TDVecLine &line, TDMatPoint point, double tolerance, TDVecLineHitKind expected,
...
int main() {
  ...
  if (line.HitTest(&graphicEngine, {0.0, 49.0}, graphicEngine.GetMouseTolerance()).kind !=
