...
int expect(bool condition, const std::string &message) { return condition ? 0 : fail(message); }

TestFrameExtents extentsOf(const TDVecObject *object) {
  const TDMatRect frame = object->GetFrame();
  return {std::min(std::min(frame.P1.x, frame.P2.x), std::min(frame.P3.x, frame.P4.x)),
...
int main() {
  ...
  if (int result =
          expect(model.GetLockPositionForSelectedObjects() == 0, "initial selected position lock count failed")) {
    return result;
  }
  if (int result =
          expect(model.SetLockResizeForSelectedObjects(true), "SetLockResizeForSelectedObjects returned false")) {
    return result;
  }
  ...
  model.SetChanged(false);
  if (int result =
          expect(model.SetLockPositionForSelectedObjects(true), "SetLockPositionForSelectedObjects returned false")) {
    return result;
  }
  ...
  model.SetChanged(false);
  if (int result =
          expect(firstLine->GetLockResize() && secondLine->GetLockResize(), "selected resize locks were not set")) {
    return result;
  }
  if (int result = expect(firstLine->GetLockPosition() && secondLine->GetLockPosition(),
                          "selected position locks were not set")) {
    return result;
  }
  if (int result =
          expect(model.GetLockResizeForSelectedObjects() == 2, "selected resize lock count after set failed")) {
    return result;
  }
  if (int result =
          expect(model.GetLockPositionForSelectedObjects() == 2, "selected position lock count after set failed")) {
    return result;
  }
  if (int result = expect(model.SetLockResizeForSelectedObjects(false),
                          "SetLockResizeForSelectedObjects false returned false")) {
    return result;
  }
  if (int result = expect(model.SetLockPositionForSelectedObjects(false),
                          "SetLockPositionForSelectedObjects false returned false")) {
    return result;
  }
  if (int result = expect(!firstLine->GetLockResize() && !secondLine->GetLockResize(),
                          "selected resize locks were not cleared")) {
    return result;
  }
  if (int result = expect(!firstLine->GetLockPosition() && !secondLine->GetLockPosition(),
                          "selected position locks were not cleared")) {
    return result;
  }

  {
    ...
    if (int result =
            expect(alignModel.AlignSelectedObjects(TDVecAlignMode::Left) == 1, "align left moved count failed")) {
      return result;
    }
  ...
  }
  {
    ...
    alignModel.SelectObject(1);
    if (int result =
            expect(alignModel.AlignSelectedObjects(TDVecAlignMode::Right) == 1, "align right moved count failed")) {
      return result;
    }
  ...
  }
  {
    ...
    alignModel.SelectObject(1);
    if (int result =
            expect(alignModel.AlignSelectedObjects(TDVecAlignMode::Top) == 1, "align top moved count failed")) {
      return result;
    }
  ...
  }
  {
    ...
    alignModel.SelectObject(1);
    if (int result =
            expect(alignModel.AlignSelectedObjects(TDVecAlignMode::Bottom) == 1, "align bottom moved count failed")) {
      return result;
    }
  ...
  }
  {
    ...
    alignModel.SelectObject(0);
    alignModel.SelectObject(1);
    if (int result = expect(alignModel.AlignSelectedObjects(TDVecAlignMode::HorizontalCenter) == 2,
                            "align center moved count failed")) {
      return result;
    }
  ...
  }
  {
    ...
    alignModel.SelectObject(0);
    alignModel.SelectObject(1);
    if (int result = expect(alignModel.AlignSelectedObjects(TDVecAlignMode::VerticalMiddle) == 2,
                            "align middle moved count failed")) {
      return result;
    }
  ...
  }
  {
    ...
    alignModel.SelectObject(0);
    alignModel.SelectObject(1);
    if (int result = expect(alignModel.AlignSelectedObjects(TDVecAlignMode::Right) == 1,
                            "align did not respect lock position moved count")) {
      return result;
    }
  ...
  model.DeselectAll();
  if (int result = expect(!model.SetLockResizeForSelectedObjects(true),
                          "SetLockResizeForSelectedObjects accepted empty selection")) {
    return result;
  }
  if (int result = expect(!model.SetLockPositionForSelectedObjects(true),
                          "SetLockPositionForSelectedObjects accepted empty selection")) {
    return result;
  }
  if (int result = expect(model.SelectObjectsInArea({-1.0, -1.0}, {101.0, 1.0}, false) == 1,
                          "SelectObjectsInArea count failed")) {
    return result;
  }
  if (int result = expect(firstLine->GetSelect() && !secondLine->GetSelect(), "SelectObjectsInArea selection failed")) {
    return result;
  }
  if (int result = expect(model.SelectObjectsInArea({-1.0, 9.0}, {101.0, 11.0}, true) == 1,
                          "SelectObjectsInArea add count failed")) {
    return result;
  }
  if (int result =
          expect(firstLine->GetSelect() && secondLine->GetSelect(), "SelectObjectsInArea add selection failed")) {
    return result;
  }
  ...
  if (int result = expect(dynamic_cast<TDVecLine *>(model.GetObject(0)) != nullptr &&
                              dynamic_cast<TDVecLine *>(model.GetObject(1)) != nullptr,
                          "resolved group did not restore line objects")) {
    return result;
  }
  ...
  if (int result =
          expect(model.DeleteSelectedObjects() == 1, "DeleteSelectedObjects did not skip locked selected object")) {
    return result;
  }
...

  {
    ...
    if (int result =
            expectEqual(extentsOf(first).right, extentsOf(second).right, "redo did not restore aligned state")) {
      return result;
    }
  }
