...
bool nearlyEqual(double a, double b) { return std::fabs(a - b) < 0.000001; }
...
int expectEllipse(const TDVecEllipse &ellipse, double xCenter, double yCenter, double xRadius, double yRadius,
                  double angle, const std::string &label) {
  const TDMatEllipse actual = ellipse.GetEllipse();
  return expect(nearlyEqual(actual.xCenter, xCenter) && nearlyEqual(actual.yCenter, yCenter) &&
                    nearlyEqual(actual.xRadius, xRadius) && nearlyEqual(actual.yRadius, yRadius) &&
                    nearlyEqual(actual.nAngle, angle),
                label);
}

int expectMatEllipse(const TDMatEllipse &ellipse, double xCenter, double yCenter, double xRadius, double yRadius,
                     double angle, const std::string &label) {
  return expect(nearlyEqual(ellipse.xCenter, xCenter) && nearlyEqual(ellipse.yCenter, yCenter) &&
                    nearlyEqual(ellipse.xRadius, xRadius) && nearlyEqual(ellipse.yRadius, yRadius) &&
...
int main() {
  {
    ...
    if (int result = expectMatEllipse(ellipse, 0.0, 0.0, std::sqrt(200.0), std::sqrt(50.0), -45.0,
...

  {
    ...
    if (int result = expect(ellipse.GetXRadius() > 0.0 && ellipse.GetYRadius() > 0.0,
                            "rotated ellipse node move produced invalid radii")) {
      return result;
    }
  }

  {
    ...
    if (int result =
            expectEllipse(*createdEllipse(model), 0.0, 0.0, 10.0, 10.0, 0.0, "circle midpoint geometry mismatch")) {
      return result;
    }
    if (int result =
            expect(createdEllipse(model)->GetResizeProportional(), "circle midpoint was not marked proportional")) {
      return result;
    }
    createdEllipse(model)->MoveNode(3, 5.0, 0.0, {15.0, 0.0});
    if (int result = expectEllipse(*createdEllipse(model), 0.0, 0.0, 15.0, 15.0, 0.0,
                                   "circle midpoint did not stay circle after node move")) {
      return result;
    }
  }

  {
    ...
    if (int result = expect(editor.GetUsedCursor() == VECVIEW_CREATE_ELLIPSE_ROTATED_2,
                            "rotated ellipse did not enter second cursor after one preview move")) {
      return result;
    }
    ...
    if (int result =
            expect(model.CountObjects() == 1, "rotated ellipse second-click without preview did not create object")) {
      return result;
    }
    if (int result = expectEllipse(*createdEllipse(model), 0.0, 0.0, std::sqrt(200.0), std::sqrt(50.0), -45.0,
...

  {
    ...
    if (int result =
            expectEllipse(*createdEllipse(model), 5.0, 0.0, 5.0, 5.0, 0.0, "circle diameter geometry mismatch")) {
      return result;
    }
    if (int result =
            expect(createdEllipse(model)->GetResizeProportional(), "circle diameter was not marked proportional")) {
      return result;
    }
  }

  {
    ...
    if (int result =
            expectEllipse(*createdEllipse(model), 0.0, 0.0, 10.0, 10.0, 0.0, "circle edge geometry mismatch")) {
      return result;
    }
    if (int result =
            expect(createdEllipse(model)->GetResizeProportional(), "circle edge was not marked proportional")) {
      return result;
    }
  }

  {
    ...
    if (int result =
            expectEllipse(*createdEllipse(model), 10.0, 5.0, 10.0, 5.0, 0.0, "orthogonal ellipse geometry mismatch")) {
      return result;
    }
    ...
    if (int result = expectEllipse(*createdEllipse(model), 15.0, 10.0, 10.0, 5.0, 0.0,
                                   "selected ellipse was not movable through model")) {
      return result;
    }
  }

  {
    ...
    if (int result =
            expectEllipse(*createdEllipse(model), 0.0, 0.0, 10.0, 5.0, 0.0, "rotated ellipse geometry mismatch")) {
      return result;
    }
  }

  {
    ...
    if (int result = expectEllipse(*createdEllipse(model), 0.0, 0.0, 10.0, 5.0, 0.0,
                                   "rotated ellipse third-click geometry mismatch")) {
      return result;
    }
  }
