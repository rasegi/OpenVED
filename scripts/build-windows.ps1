...
# "Launch OpenVED" action is a Directory/ExeCommand custom action, so no Util
# extension is required. 'wix extension add -g' is idempotent.
Write-Host "    ensuring WiX extension WixToolset.UI.wixext/$WixVersion"
