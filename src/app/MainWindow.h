...
private:
  ...
  QAction *addToolAction(QToolBar *toolbar, const QString &text, const QString &iconName, bool checkable = false,
  ...
  enum class TextDockMode { None, CreateText, CreateFrameTextBox, Modify };
