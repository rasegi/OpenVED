...
void MainWindow::createToolBars() {
  ...
  auto *newAction =
      addToolAction(fileToolbar, QStringLiteral("New"), QStringLiteral("new.bmp"), false, QStringLiteral("New"));
  newAction->setProperty("implemented", true);
  newAction->setEnabled(true);
  connect(newAction, &QAction::triggered, this, [this] { newDocument(); });
  auto *openAction =
      addToolAction(fileToolbar, QStringLiteral("Open"), QStringLiteral("open.bmp"), false, QStringLiteral("Open"));
  openAction->setProperty("implemented", true);
  openAction->setEnabled(true);
  connect(openAction, &QAction::triggered, this, [this] { openDocument(); });
  auto *saveAction =
      addToolAction(fileToolbar, QStringLiteral("Save"), QStringLiteral("save.bmp"), false, QStringLiteral("Save"));
  ...
  fileToolbar->addSeparator();
  cutAction_ =
      addToolAction(fileToolbar, QStringLiteral("Cut"), QStringLiteral("cut.bmp"), false, QStringLiteral("Cut"));
  ...
  copyAction_ =
      addToolAction(fileToolbar, QStringLiteral("Copy"), QStringLiteral("copy.bmp"), false, QStringLiteral("Copy"));
  ...
  pasteAction_ =
      addToolAction(fileToolbar, QStringLiteral("Paste"), QStringLiteral("paste.bmp"), false, QStringLiteral("Paste"));
  ...
  fileToolbar->addSeparator();
  auto *printToolAction =
      addToolAction(fileToolbar, QStringLiteral("Print"), QStringLiteral("print.bmp"), false, QStringLiteral("Print"));
  ...
  auto *lineAction = addToolAction(createToolbar, QStringLiteral("Line"), QStringLiteral("line.bmp"), true,
                                   QStringLiteral("VOC_LINE"));
  ...
  auto addCreateOperationAction = [this, createToolbar, createActionGroup](const QString &text, const QString &iconName,
  ...
  addCreateOperationAction(QStringLiteral("Polygon"), QStringLiteral("polygon.bmp"), VOC_POLYGON_SMARTLINE,
                           QStringLiteral("VOC_POLYGON_SMARTLINE"));
  auto *polyCurveAction = addCreateOperationAction(QStringLiteral("PolyCurve"), QStringLiteral("polycurve.bmp"),
                                                   VOC_POLYCURVE, QStringLiteral("VOC_POLYCURVE"));
  ...
  addCreateOperationAction(QStringLiteral("bz"), QString(), VOC_BEZIERCURVE_CONTROLPOINT,
                           QStringLiteral("VOC_BEZIERCURVE_CONTROLPOINT"));
  auto *bsplineAction = addCreateOperationAction(QStringLiteral("B-Spline"), QStringLiteral("bspline.bmp"),
                                                 VOC_BSPLINE_CONTROLPOINT, QStringLiteral("VOC_BSPLINE_CONTROLPOINT"));
  ...
  addCreateOperationAction(QStringLiteral("Circle"), QStringLiteral("circle_radius.bmp"), VOC_CIRCLE_MIDPOINT,
                           QStringLiteral("VOC_CIRCLE_MIDPOINT"));
  addCreateOperationAction(QStringLiteral("Circle 3 Points"), QStringLiteral("circle_3points.bmp"), VOC_CIRCLE_EDGE,
                           QStringLiteral("VOC_CIRCLE_EDGE"));
  addCreateOperationAction(QStringLiteral("Circle Diameter"), QStringLiteral("circle_diameter.bmp"),
                           VOC_CIRCLE_DIAMETER, QStringLiteral("VOC_CIRCLE_DIAMETER"));
  addCreateOperationAction(QStringLiteral("Circle Diagonal"), QStringLiteral("circle_square.bmp"), VOC_CIRCLE_DIAGONAL,
                           QStringLiteral("VOC_CIRCLE_DIAGONAL"));
  createToolbar->addSeparator();
  addCreateOperationAction(QStringLiteral("Ellipse Orthogonal"), QStringLiteral("ellipse_orthogonal.bmp"),
                           VOC_ELLIPSE_ORTHOGONAL, QStringLiteral("VOC_ELLIPSE_ORTHOGONAL"));
  addCreateOperationAction(QStringLiteral("Ellipse Rotated"), QStringLiteral("ellipse_rotated.bmp"),
                           VOC_ELLIPSE_MIDPOINT, QStringLiteral("VOC_ELLIPSE_MIDPOINT"));
  addCreateOperationAction(QStringLiteral("Rectangle Orthogonal"), QStringLiteral("rectangle_orthogonal.bmp"),
                           VOC_RECTANGLE_NOTROTATED, QStringLiteral("VOC_RECTANGLE_NOTROTATED"));
  addCreateOperationAction(QStringLiteral("Rectangle Rotated"), QStringLiteral("rectangle_rotated.bmp"),
                           VOC_RECTANGLE_ROTATED, QStringLiteral("VOC_RECTANGLE_ROTATED"));
  auto *roundRectangleAction =
      addCreateOperationAction(QStringLiteral("Round Rectangle"), QStringLiteral("roundrect_orthogonal.bmp"),
                               VOC_ROUND_RECTANGLE_NOTROTATED, QStringLiteral("VOC_ROUND_RECTANGLE_NOTROTATED"));
  ...
  createToolbar->addSeparator();
  createTextAction_ = addToolAction(createToolbar, QStringLiteral("Text"), QStringLiteral("text.bmp"), true,
                                    QStringLiteral("VOC_VECTEXT"));
  ...
  createFrameTextAction_ = addToolAction(createToolbar, QStringLiteral("Frame Text"), QStringLiteral("drawtext.bmp"),
                                         true, QStringLiteral("VOC_VECFRAMETEXT_EMPTY"));
  ...
  connect(createActionGroup, &QActionGroup::triggered, this, [this](QAction *action) {
    if (!action->property("createOperation").toBool() &&
        canvas_->interactionMode() == QVedWidget::InteractionMode::CreateLine) {
      canvas_->setInteractionMode(QVedWidget::InteractionMode::None);
    }
  ...
  auto *selectAction = addToolAction(modifyToolbar, QStringLiteral("Select"), QStringLiteral("select.bmp"), true,
                                     QStringLiteral("VOM_SELECT_MOVE_NODE_OBJECT"));
  ...
  auto *selectScaleAction =
      addToolAction(modifyToolbar, QStringLiteral("Select/Scale"), QStringLiteral("selectscale0.bmp"), true,
                    QStringLiteral("VOM_SELECTMOVE_OBJECT_SCALE_FRAME"));
  ...
  moveObjectAction_ = addToolAction(modifyToolbar, QStringLiteral("Move Object"), QStringLiteral("move_object.bmp"),
                                    true, QStringLiteral("VOM_MOVE_OBJECT"));
  ...
  auto addModifyOperationAction = [&](const QString &text, const QString &iconName, TDViewOperationEnum operation,
                                      const QString &operationName) {
  ...
  moveNodeAction_ = addModifyOperationAction(QStringLiteral("Move Node"), QStringLiteral("move_node.bmp"),
                                             VOM_MOVE_NODE, QStringLiteral("VOM_MOVE_NODE"));
  moveBsplineControlPointAction_ =
      addModifyOperationAction(QStringLiteral("Move B-Spline Node"), QStringLiteral("move_bspline_node.bmp"),
                               VOM_MOVE_BSPLINE_CONTROLPOINT, QStringLiteral("VOM_MOVE_BSPLINE_CONTROLPOINT"));
  insertNodeAction_ = addModifyOperationAction(QStringLiteral("Insert Node"), QStringLiteral("insert_node.bmp"),
                                               VOM_INSERT_NODE, QStringLiteral("VOM_INSERT_NODE"));
  deleteNodeAction_ = addModifyOperationAction(QStringLiteral("Delete Node"), QStringLiteral("delete_node.bmp"),
                                               VOM_DELETE_NODE, QStringLiteral("VOM_DELETE_NODE"));
  auto *deleteObjectAction =
      addToolAction(modifyToolbar, QStringLiteral("Delete Object"), QStringLiteral("delete_interactive.bmp"), true,
                    QStringLiteral("VOM_DELETE_OBJECT"));
  ...
  auto *changeEdgeRoundNodeAction =
      addToolAction(modifyToolbar, QStringLiteral("Change Edge Round Node"), QStringLiteral("change_node.bmp"), true,
  ...
  rotateObjectAction_ =
      addModifyOperationAction(QStringLiteral("Rotate Object"), QStringLiteral("rotate_object.bmp"),
                               VOM_ROTATE_OBJECT_ACTIVEPOINT, QStringLiteral("VOM_ROTATE_OBJECT_ACTIVEPOINT"));
  ...
  scaleObjectAction_ = addModifyOperationAction(QStringLiteral("Scale Object"), QStringLiteral("scale_object.bmp"),
                                                VOM_SCALE_OBJECT_3POINT, QStringLiteral("VOM_SCALE_OBJECT_3POINT"));
  modifyCurveAttributeAction_ =
      addModifyOperationAction(QStringLiteral("Modify Curve Attribute"), QStringLiteral("change_bspline_attr.bmp"),
                               VOM_MODIFY_CURVE_ATTRIBUTE, QStringLiteral("VOM_MODIFY_CURVE_ATTRIBUTE"));
  ...
  connect(modifyCurveAttributeAction_, &QAction::toggled, this, [this](bool checked) {
    if (!checked && curveDock_ && operationManager_ &&
  ...
  modifyTextAction_ = addToolAction(modifyToolbar, QStringLiteral("Text Properties"),
                                    QStringLiteral("text_properties.bmp"), true, QStringLiteral("VOM_VECTEXT"));
  ...
  modifyToolbar->addSeparator();
  auto *makeGroupAction = addToolAction(modifyToolbar, QStringLiteral("Make Group"), QStringLiteral("make_group.bmp"),
                                        false, QStringLiteral("cmdMakeGroup"));
  ...
  auto *resolveGroupAction =
      addToolAction(modifyToolbar, QStringLiteral("Resolve Group"), QStringLiteral("resolve_group.bmp"), false,
                    QStringLiteral("cmdResolveGroup"));
  ...
  lockObjectAction_ = addToolAction(modifyToolbar, QStringLiteral("Lock Object"), QStringLiteral("forbidden_sign.bmp"),
                                    true, QStringLiteral("cmdLockObject"));
  ...
  zoomAction_ = addToolAction(viewToolbar, QStringLiteral("Zoom"), QStringLiteral("zoom.bmp"), true,
                              QStringLiteral("VOP_ZOOM_INOUT"));
  ...
  connect(zoomAction_, &QAction::triggered, this, [this] {
    ...
    statusBar()->showMessage(QStringLiteral("VOP_ZOOM_INOUT %1")
                                 .arg(zoomAction_->isChecked() ? QStringLiteral("on") : QStringLiteral("off")),
                             1500);
  });
  ...
  auto *resetViewToolbarAction =
      viewToolbar->addAction(QIcon(QStringLiteral(":/ved/toolbar/reset_view.png")), QStringLiteral("Reset View"));
  ...
  showGridAction_ = addToolAction(viewToolbar, QStringLiteral("Show Grid"), QStringLiteral("show_grid.bmp"), true,
                                  QStringLiteral("cmdShowGrid"));
  ...
  connect(showGridAction_, &QAction::triggered, this, [this] {
    ...
    statusBar()->showMessage(QStringLiteral("cmdShowGrid %1")
                                 .arg(showGridAction_->isChecked() ? QStringLiteral("on") : QStringLiteral("off")),
                             1500);
  });
  gridLockAction_ = addToolAction(viewToolbar, QStringLiteral("Use Grid"), QStringLiteral("use_grid.bmp"), true,
                                  QStringLiteral("cmdLockGrid"));
  ...
  connect(gridLockAction_, &QAction::triggered, this, [this] {
    ...
    statusBar()->showMessage(QStringLiteral("cmdLockGrid %1")
                                 .arg(gridLockAction_->isChecked() ? QStringLiteral("on") : QStringLiteral("off")),
                             1500);
  });
  ...
  connect(showRulersAction_, &QAction::triggered, this, [this] {
    ...
    statusBar()->showMessage(QStringLiteral("cmdShowRulers %1")
                                 .arg(showRulersAction_->isChecked() ? QStringLiteral("on") : QStringLiteral("off")),
                             1500);
  });
  mouseToleranceCrossAction_ =
      viewToolbar->addAction(makeMouseToleranceCrossIcon(), QStringLiteral("Mouse Tolerance Cross"));
  ...
  viewToolbar->addSeparator();
  auto addAlignAction = [this, viewToolbar](const QString &text, const QString &iconName, TDVecAlignMode mode,
  ...
  addAlignAction(QStringLiteral("Align Left"), QStringLiteral("align_left.bmp"), TDVecAlignMode::Left,
                 QStringLiteral("cmdAlignLeft"));
  addAlignAction(QStringLiteral("Align Center"), QStringLiteral("align_center.bmp"), TDVecAlignMode::HorizontalCenter,
                 QStringLiteral("cmdAlignCenter"));
  addAlignAction(QStringLiteral("Align Right"), QStringLiteral("align_right.bmp"), TDVecAlignMode::Right,
                 QStringLiteral("cmdAlignRight"));
  addAlignAction(QStringLiteral("Align Top"), QStringLiteral("align_top.bmp"), TDVecAlignMode::Top,
                 QStringLiteral("cmdAlignTop"));
  addAlignAction(QStringLiteral("Align Middle"), QStringLiteral("align_middle.bmp"), TDVecAlignMode::VerticalMiddle,
                 QStringLiteral("cmdAlignMiddle"));
  addAlignAction(QStringLiteral("Align Bottom"), QStringLiteral("align_bottom.bmp"), TDVecAlignMode::Bottom,
                 QStringLiteral("cmdAlignBottom"));
  updateGroupCommandActions();
  updateModifyCommandActions();
}

QAction *MainWindow::addToolAction(QToolBar *toolbar, const QString &text, const QString &iconName, bool checkable,
                                   const QString &toolTip) {
  auto *action = iconName.isEmpty() ? toolbar->addAction(text)
