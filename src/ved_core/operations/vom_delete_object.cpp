...
TDVOMDeleteObject::TDVOMDeleteObject(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                                     TDViewOperationManager *pParentOperationManager)
    : TDVOModify(pVecModel, pVecEditCad, pParentOperationManager), mClick(0), miIndexObject(-1) {
...
TDVOMDeleteObject::TDVOMDeleteObject(const TDVOMDeleteObject &oldOperation)
    : TDVOModify(oldOperation), mClick(oldOperation.mClick), miIndexObject(oldOperation.miIndexObject) {}
...
TDVOMDeleteObject *TDVOMDeleteObject::Clone() const { return new TDVOMDeleteObject(*this); }
