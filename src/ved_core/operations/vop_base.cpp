...
//   Contructor with Parameter
//------------------------------------------------------------------------------
TDViewOperation::TDViewOperation(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
...
TDViewOperationState TDViewOperation::GetState() {
  if (!this || !meOperationState)
    return (OSTATE_UNKNOWN);
...
//  Contructor with Parameter
//------------------------------------------------------------------------------
TDVOCreate::TDVOCreate(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                       TDViewOperationManager *pParentOperationManager)
    : TDViewOperation(pVecModel, pVecEditCad, pParentOperationManager) {}
//------------------------------------------------------------------------------
// ! Copy Contructor
//------------------------------------------------------------------------------
TDVOCreate::TDVOCreate(const TDVOCreate &VOCreate) : TDViewOperation(VOCreate) {
...
//  Contructor with Parameter
//------------------------------------------------------------------------------
TDVOModify::TDVOModify(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                       TDViewOperationManager *pParentOperationManager)
    : TDViewOperation(pVecModel, pVecEditCad, pParentOperationManager) {}
//------------------------------------------------------------------------------
// ! Copy Contructor
//------------------------------------------------------------------------------
TDVOModify::TDVOModify(const TDVOModify &VOModify) : TDViewOperation(VOModify) {
