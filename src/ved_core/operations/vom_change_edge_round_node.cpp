...
TDVOMChangeEdgeRoundNode::TDVOMChangeEdgeRoundNode(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                                                   TDViewOperationManager *pParentOperationManager)
    : TDVOModify(pVecModel, pVecEditCad, pParentOperationManager), meObjectType(VECOBJ_UNKNOWN), mbChangeOK(false),
      mbObjectTypeOK(false), mbOnObject(false), miNode(-1) {
...
TDVOMChangeEdgeRoundNode::TDVOMChangeEdgeRoundNode(const TDVOMChangeEdgeRoundNode &oldOperation)
    : TDVOModify(oldOperation), meObjectType(oldOperation.meObjectType), mbChangeOK(oldOperation.mbChangeOK),
      mbObjectTypeOK(oldOperation.mbObjectTypeOK), mbOnObject(oldOperation.mbOnObject), miNode(oldOperation.miNode) {}
...
TDVOMChangeEdgeRoundNode *TDVOMChangeEdgeRoundNode::Clone() const { return new TDVOMChangeEdgeRoundNode(*this); }
...
void __fastcall TDVOMChangeEdgeRoundNode::OPMouseDown(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                      double Y) {
  (void)Shift;
...
void __fastcall TDVOMChangeEdgeRoundNode::OPMouseUp(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                    double Y) {
  (void)Shift;
  (void)X;
  (void)Y;
...
void __fastcall TDVOMChangeEdgeRoundNode::OPMouseMove(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                      double Y) {
  (void)Button;
  (void)Shift;
  (void)X;
