...
TDViewOperationManager::TDViewOperationManager()
    : mpAktiveOperation(nullptr), mpVecModel(nullptr), mpVecEditCad(nullptr), mbChangedVOPExternalVariables(false),
      meDefaultOperation(VO_UNKNOWN), mbActiveChangeToDefOPAfterFinish(false), mbActiveChangeToDefOPAfterAbort(false),
      clipboardObjects_(), clipboardPasteCount_(1), undoStack_(), redoStack_() {}
...
TDViewOperationManager::~TDViewOperationManager() { delete mpAktiveOperation; }
...
TDVecModel *TDViewOperationManager::GetVecModel() { return mpVecModel; }
...
TDVecEditCad *TDViewOperationManager::GetVecEditCad() { return mpVecEditCad; }
...
TDViewOperationEnum TDViewOperationManager::GetDefaultOperation() { return meDefaultOperation; }
...
bool TDViewOperationManager::GetActiveChangeToDefOPAfterFinish() { return mbActiveChangeToDefOPAfterFinish; }

void TDViewOperationManager::SetActiveChangeToDefOPAfterAbort(bool bValue) { mbActiveChangeToDefOPAfterAbort = bValue; }

bool TDViewOperationManager::GetActiveChangeToDefOPAfterAbort() { return mbActiveChangeToDefOPAfterAbort; }
...
const TDViewOperation *TDViewOperationManager::GetAktiveOperation() const { return mpAktiveOperation; }
...
bool TDViewOperationManager::HasClipboardObjects() const { return !clipboardObjects_.empty(); }
...
bool TDViewOperationManager::CanUndo() const { return !undoStack_.empty(); }

bool TDViewOperationManager::CanRedo() const { return !redoStack_.empty(); }
...
void TDViewOperationManager::RecordHistoryIfChanged(const std::string &name, TDVecModelSnapshot before,
...
bool TDViewOperationManager::IsVOPExternalVariablesChanged() { return mbChangedVOPExternalVariables; }

void TDViewOperationManager::VOPExternalVariablesIsChanged() { mbChangedVOPExternalVariables = true; }

void TDViewOperationManager::SendUpdateExtVarToParent() { VOPExternalVariablesIsChanged(); }
