...
TDVOMModifyCurveAttribute::TDVOMModifyCurveAttribute(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                                                     TDViewOperationManager *pParentOperationManager)
    : TDVOModify(pVecModel, pVecEditCad, pParentOperationManager), mpVOMModifyCurveAttributeExtVar(nullptr),
      mpObjBSPLine(nullptr), mpObjPolyCurve(nullptr), mbChangeOK(false), mnDegree(0), mnResolution(0),
      mbShowPolygon(false), mbShowControls(false), mbCopy(false) {
...
TDVOMModifyCurveAttribute::TDVOMModifyCurveAttribute(const TDVOMModifyCurveAttribute &oldOperation)
    : TDVOModify(oldOperation), mpVOMModifyCurveAttributeExtVar(nullptr), mpObjBSPLine(oldOperation.mpObjBSPLine),
      mpObjPolyCurve(oldOperation.mpObjPolyCurve), mbChangeOK(oldOperation.mbChangeOK), mnDegree(oldOperation.mnDegree),
      mnResolution(oldOperation.mnResolution), mbShowPolygon(oldOperation.mbShowPolygon),
      mbShowControls(oldOperation.mbShowControls), mbCopy(oldOperation.mbCopy) {
...
TDVOMModifyCurveAttribute *TDVOMModifyCurveAttribute::Clone() const { return new TDVOMModifyCurveAttribute(*this); }
...
void __fastcall TDVOMModifyCurveAttribute::OPMouseDown(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                       double Y) {
  (void)Button;
  (void)Shift;
  (void)X;
...
void __fastcall TDVOMModifyCurveAttribute::OPMouseUp(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                     double Y) {
  (void)Button;
  (void)Shift;
  (void)X;
...
void __fastcall TDVOMModifyCurveAttribute::OPMouseMove(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                       double Y) {
  (void)Button;
  (void)Shift;
  (void)X;
...
TDVOMModifyCurveAttributeExtVar::TDVOMModifyCurveAttributeExtVar(TDViewOperation *pParentOperation)
    : TDVOPExternalVariables(pParentOperation), mnDegree(0), mnResolution(0), mbShowControls(false),
      mbShowPolygon(false), mbCopy(false), meObjectType(VECOBJ_UNKNOWN) {}

TDVOMModifyCurveAttributeExtVar::TDVOMModifyCurveAttributeExtVar(const TDVOMModifyCurveAttributeExtVar &oldExtVar)
    : TDVOPExternalVariables(oldExtVar), mnDegree(oldExtVar.mnDegree), mnResolution(oldExtVar.mnResolution),
      mbShowControls(oldExtVar.mbShowControls), mbShowPolygon(oldExtVar.mbShowPolygon), mbCopy(oldExtVar.mbCopy),
      meObjectType(oldExtVar.meObjectType) {}

TDVOMModifyCurveAttributeExtVar &
TDVOMModifyCurveAttributeExtVar::operator=(const TDVOMModifyCurveAttributeExtVar &oldExtVar) {
  if (this == &oldExtVar) {
    return *this;
  }
...
void TDVOMModifyCurveAttributeExtVar::SetDegree(int nDegree) { mnDegree = nDegree; }

int TDVOMModifyCurveAttributeExtVar::GetDegree() const { return mnDegree; }

void TDVOMModifyCurveAttributeExtVar::SetResolution(unsigned int nResolution) { mnResolution = nResolution; }

unsigned int TDVOMModifyCurveAttributeExtVar::GetResolution() const { return mnResolution; }

void TDVOMModifyCurveAttributeExtVar::SetShowControls(bool bShowControls) { mbShowControls = bShowControls; }

bool TDVOMModifyCurveAttributeExtVar::GetShowControls() const { return mbShowControls; }

void TDVOMModifyCurveAttributeExtVar::SetShowPolygon(bool bShowPolygon) { mbShowPolygon = bShowPolygon; }

bool TDVOMModifyCurveAttributeExtVar::GetShowPolygon() const { return mbShowPolygon; }

void TDVOMModifyCurveAttributeExtVar::SetCopyFlag(bool bCopy) { mbCopy = bCopy; }

bool TDVOMModifyCurveAttributeExtVar::GetCopyFlag() const { return mbCopy; }

void TDVOMModifyCurveAttributeExtVar::SetObjectType(TDVecObjectType eObjectType) { meObjectType = eObjectType; }

TDVecObjectType TDVOMModifyCurveAttributeExtVar::GetObjectType() const { return meObjectType; }
