...
TDVOCCircleDiagonal::TDVOCCircleDiagonal(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
...
TDVOCCircleDiagonal::TDVOCCircleDiagonal(const TDVOCCircleDiagonal &oldOperation)
    : TDVOCreate(oldOperation),
      ...
      mMatEllipse(oldOperation.mMatEllipse), mbEllipseOK(oldOperation.mbEllipseOK) {}
...
TDVOCCircleDiagonal *TDVOCCircleDiagonal::Clone() const { return new TDVOCCircleDiagonal(*this); }

void __fastcall TDVOCCircleDiagonal::OPMouseDown(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                 double Y) {
  (void)Shift;
...
void __fastcall TDVOCCircleDiagonal::OPMouseMove(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                 double Y) {
  (void)Shift;
