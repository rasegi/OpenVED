...
// ! Copy Constructor
//---------------------------------------------------------------------------
TDVOCLine::TDVOCLine(const TDVOCLine &OldOperation) : TDVOCreate(OldOperation) {
...
// ! Clone Methode
//---------------------------------------------------------------------------
TDVOCLine *TDVOCLine::Clone(void) const { return (new TDVOCLine(*this)); }
//---------------------------------------------------------------------------
//  DESC. :
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
TDVocLineExtVar::TDVocLineExtVar(TDViewOperation *pParentOperation) : TDVOPExternalVariables(pParentOperation) {
...
//---------------------------------------------------------------------------
TDVocLineExtVar::TDVocLineExtVar(const TDVocLineExtVar &OldExtVar) : TDVOPExternalVariables(OldExtVar) {
...
//  DESC. : Clone Methode
//---------------------------------------------------------------------------
TDVocLineExtVar *TDVocLineExtVar::Clone(void) const { return (new TDVocLineExtVar(*this)); }
//---------------------------------------------------------------------------
//  DESC. : Set- und Get Methode for Interne-Variables
//---------------------------------------------------------------------------
void TDVocLineExtVar::SetMatLine(TDMatLine MatLine) { mMatLine.Create(&MatLine); }

TDMatLine TDVocLineExtVar::GetMatLine(void) { return (mMatLine); }

void TDVocLineExtVar::SetMatPoint(TDMatPoint MatPoint) { mMatPoint.Create(&MatPoint); }
TDMatPoint TDVocLineExtVar::GetMatPoint(void) { return (mMatPoint); }
