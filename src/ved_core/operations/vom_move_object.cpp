...
TDVOMMoveObject::TDVOMMoveObject(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                                 TDViewOperationManager *pParentOperationManager)
    : TDVOModify(pVecModel, pVecEditCad, pParentOperationManager), mMouseStart{0.0, 0.0}, mbGroupMove(false),
      mbDragOK(false) {
...
TDVOMMoveObject::TDVOMMoveObject(const TDVOMMoveObject &oldOperation)
    : TDVOModify(oldOperation), mMouseStart(oldOperation.mMouseStart), mbGroupMove(oldOperation.mbGroupMove),
...
TDVOMMoveObject *TDVOMMoveObject::Clone() const { return new TDVOMMoveObject(*this); }
