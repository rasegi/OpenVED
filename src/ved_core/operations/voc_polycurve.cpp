...
TDVOCPolyCurve::TDVOCPolyCurve(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                               TDViewOperationManager *pParentOperationManager)
    : TDVOCreate(pVecModel, pVecEditCad, pParentOperationManager), mpVOCPolyCurveExtVar(nullptr), mpTmpObject(nullptr),
      mMatLine{}, mConturPoints(), mbPolyCurveOK(false), mePreviusPointType(CPT_PRIME_LINE) {
...
TDVOCPolyCurve::TDVOCPolyCurve(const TDVOCPolyCurve &oldOperation)
    : TDVOCreate(oldOperation.mpVecModel, oldOperation.mpVecEditCad, oldOperation.mpParentOperationManager),
      ...
      mMatLine(oldOperation.mMatLine), mConturPoints(oldOperation.mConturPoints),
      mbPolyCurveOK(oldOperation.mbPolyCurveOK), mePreviusPointType(oldOperation.mePreviusPointType) {
...
TDVOCPolyCurve *TDVOCPolyCurve::Clone() const { return new TDVOCPolyCurve(*this); }
...
TDVOCPolyCurveExtVar::TDVOCPolyCurveExtVar(TDViewOperation *pParentOperation)
    : TDVOPExternalVariables(pParentOperation), mnResolution(5), mbShowControls(true), mbShowPolygon(true) {}

TDVOCPolyCurveExtVar::TDVOCPolyCurveExtVar(const TDVOCPolyCurveExtVar &oldExtVar)
    : TDVOPExternalVariables(oldExtVar), mnResolution(oldExtVar.mnResolution), mbShowControls(oldExtVar.mbShowControls),
...
TDVOCPolyCurveExtVar *TDVOCPolyCurveExtVar::Clone() const { return new TDVOCPolyCurveExtVar(*this); }

void TDVOCPolyCurveExtVar::SetResolution(unsigned int nResolution) { mnResolution = nResolution; }

unsigned int TDVOCPolyCurveExtVar::GetResolution() const { return mnResolution; }

void TDVOCPolyCurveExtVar::SetShowControls(bool bShowControls) { mbShowControls = bShowControls; }

bool TDVOCPolyCurveExtVar::GetShowControls() const { return mbShowControls; }

void TDVOCPolyCurveExtVar::SetShowPolygon(bool bShowPolygon) { mbShowPolygon = bShowPolygon; }

bool TDVOCPolyCurveExtVar::GetShowPolygon() const { return mbShowPolygon; }
