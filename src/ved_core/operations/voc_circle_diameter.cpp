...
TDVOCCircleDiameter::TDVOCCircleDiameter(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
...
bool TDVOCCircleDiameter::IsCircleValid() const { return mMatCircle.r > minimumDistance(mpVecEditCad); }
...
void __fastcall TDVOCCircleDiameter::OPMouseDown(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                 double Y) {
  (void)Shift;
  switch (GetState()) {
  case OSTATE_STARTED:
...
void __fastcall TDVOCCircleDiameter::OPMouseMove(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                 double Y) {
  (void)Shift;
