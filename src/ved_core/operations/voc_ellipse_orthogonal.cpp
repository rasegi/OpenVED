...
TDVOCEllipseOrthogonal::TDVOCEllipseOrthogonal(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
...
void __fastcall TDVOCEllipseOrthogonal::OPMouseDown(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                    double Y) {
  (void)Shift;
  switch (GetState()) {
  case OSTATE_STARTED:
...
void __fastcall TDVOCEllipseOrthogonal::OPMouseUp(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                  double Y) {
  (void)Shift;
  (void)X;
  (void)Y;
...
void __fastcall TDVOCEllipseOrthogonal::OPMouseMove(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                    double Y) {
  (void)Shift;
