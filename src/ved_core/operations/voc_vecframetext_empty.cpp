...
TDVOCVecFrameTextEmpty::TDVOCVecFrameTextEmpty(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                                               TDViewOperationManager *pParentOperationManager)
    : TDVOCreate(pVecModel, pVecEditCad, pParentOperationManager), mMatRect{}, mpTmpObject(nullptr),
      mbRectangleOK(false), mpVOCVecFrameTextEmptyExtVar(nullptr) {
...
TDVOCVecFrameTextEmpty::TDVOCVecFrameTextEmpty(const TDVOCVecFrameTextEmpty &oldOperation)
    : TDVOCreate(oldOperation.mpVecModel, oldOperation.mpVecEditCad, oldOperation.mpParentOperationManager),
      ...
      mbRectangleOK(oldOperation.mbRectangleOK), mpVOCVecFrameTextEmptyExtVar(nullptr) {
...
TDVOCVecFrameTextEmpty *TDVOCVecFrameTextEmpty::Clone() const { return new TDVOCVecFrameTextEmpty(*this); }
...
const char *TDVOCVecFrameTextEmptyExtVar::GetText() const { return msText.empty() ? nullptr : msText.c_str(); }
...
bool TDVOCVecFrameTextEmptyExtVar::TextIsOK() const { return !msText.empty(); }

bool TDVOCVecFrameTextEmptyExtVar::TextIsDeleted() const { return mbTextIsDeleted; }
