...
TDVOCRectangleNotRotated::TDVOCRectangleNotRotated(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
...
TDVOCRectangleNotRotated *TDVOCRectangleNotRotated::Clone() const { return new TDVOCRectangleNotRotated(*this); }

void __fastcall TDVOCRectangleNotRotated::OPMouseDown(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                      double Y) {
  (void)Shift;
...
void __fastcall TDVOCRectangleNotRotated::OPMouseUp(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                    double Y) {
  (void)Shift;
  (void)X;
  (void)Y;
...
void __fastcall TDVOCRectangleNotRotated::OPMouseMove(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                      double Y) {
  (void)Shift;
