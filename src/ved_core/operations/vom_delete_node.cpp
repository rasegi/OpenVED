...
TDVOMDeleteNode::TDVOMDeleteNode(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                                 TDViewOperationManager *pParentOperationManager)
    : TDVOModify(pVecModel, pVecEditCad, pParentOperationManager), meObjectType(VECOBJ_UNKNOWN), mbDeleteOK(false),
      mbObjectTypeOK(false), bOnObject(false), miNode(-1) {
...
TDVOMDeleteNode::TDVOMDeleteNode(const TDVOMDeleteNode &oldOperation)
    : TDVOModify(oldOperation), meObjectType(oldOperation.meObjectType), mbDeleteOK(oldOperation.mbDeleteOK),
      mbObjectTypeOK(oldOperation.mbObjectTypeOK), bOnObject(oldOperation.bOnObject), miNode(oldOperation.miNode) {}
...
TDVOMDeleteNode *TDVOMDeleteNode::Clone() const { return new TDVOMDeleteNode(*this); }
