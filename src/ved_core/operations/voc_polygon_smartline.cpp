...
TDVOCPolygonSmartline::TDVOCPolygonSmartline(TDVecModel *pVecModel, TDVecEditCad *pVecEditCad,
                                             TDViewOperationManager *pParentOperationManager)
    : TDVOCreate(pVecModel, pVecEditCad, pParentOperationManager), mpTmpObject(nullptr), mMatPoints() {
...
TDVOCPolygonSmartline *TDVOCPolygonSmartline::Clone() const { return new TDVOCPolygonSmartline(*this); }
...
void __fastcall TDVOCPolygonSmartline::OPMouseDown(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                   double Y) {
  switch (GetState()) {
  case OSTATE_STARTED:
    IniInteractivePoints();
...
void __fastcall TDVOCPolygonSmartline::OPMouseUp(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                 double Y) {
  (void)X;
  (void)Y;
...
void __fastcall TDVOCPolygonSmartline::OPMouseMove(TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
                                                   double Y) {
  (void)Shift;
