...
public:
  ...
  void MouseDown(TDVecViewInterfaceBase *pVecViewInterface, TDOPVirtMouseButton Button, TDOPVirtKeyState Shift,
                 double X, double Y);
  void MouseUp(TDVecViewInterfaceBase *pVecViewInterface, TDOPVirtMouseButton Button, TDOPVirtKeyState Shift, double X,
               double Y);
  void MouseMove(TDVecViewInterfaceBase *pVecViewInterface, TDOPVirtMouseButton Button, TDOPVirtKeyState Shift,
                 double X, double Y);
