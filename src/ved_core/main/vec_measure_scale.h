...
public:
  ...
  TDVecMeasureScale CalculateForView(double realPerPixel, long minimumPixelDistance, double preferredMajorStepReal,
                                     int subdivisions) const;

  std::vector<TDVecMeasureTick> BuildTicks(double visibleMinReal, double visibleMaxReal,
