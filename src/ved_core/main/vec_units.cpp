...
TDVecUnitFormatter::TDVecUnitFormatter(TDVecUnitSettings settings) : settings_(settings) {}
...
const TDVecUnitSettings &TDVecUnitFormatter::Settings() const { return settings_; }
