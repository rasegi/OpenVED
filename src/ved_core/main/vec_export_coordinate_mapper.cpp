...
TDVecExportCoordinateMapper::TDVecExportCoordinateMapper(const TDVecUnitSettings &unitSettings,
...
TDVecExportCoordinateMapper::TDVecExportCoordinateMapper(const TDVecUnitSettings &unitSettings,
    ...
    : formatter_(unitSettings), pageSettings_(pageSettings), exportSettings_(exportSettings),
...
double TDVecExportCoordinateMapper::MapX(double realX) const {
  ...
  return RealToPoints(relativeX) * exportSettings_.scaleFactor + MillimetersToPoints(exportSettings_.marginLeftMm);
}
...
double TDVecExportCoordinateMapper::PageWidthPoints() const { return MillimetersToPoints(PageWidthMm()); }

double TDVecExportCoordinateMapper::PageHeightPoints() const { return pageHeightPoints_; }

double TDVecExportCoordinateMapper::PageWidthMm() const { return formatter_.ToMillimeters(pageSettings_.widthReal); }

double TDVecExportCoordinateMapper::PageHeightMm() const { return formatter_.ToMillimeters(pageSettings_.heightReal); }
