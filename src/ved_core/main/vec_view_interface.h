...
public:
  TDVecViewInterfaceTemplate()
      : mpCallback_ViewRefresh(nullptr), mpCallback_UseCursor(nullptr), mpCallback_GetZoom(nullptr),
        mpCallback_SetZoom(nullptr), mpCallback_GetGridLock(nullptr), mpCallback_IsRectVisible(nullptr),
        mpCallback_GetMouseTolerance(nullptr), mpCallback_GetMinimumDistance(nullptr),
        mpCallback_ZoomInOutEvent(nullptr), mpObj(nullptr) {}

  inline void Register(T *pObj) { mpObj = pObj; }

  void *GetParent(void) { return (mpObj); }
  //------------------------------------------------------------
  void Send_ViewRefresh_ToView(void (T::*pCallback)(void)) { mpCallback_ViewRefresh = pCallback; }
  ...
  //------------------------------------------------------------
  void Send_UseCursor_ToView(void (T::*pCallback)(TDVecViewCursor eShape)) { mpCallback_UseCursor = pCallback; }
  ...
  void Send_GetZoom_ToView(double (T::*pCallback)(void) const) { mpCallback_GetZoom = pCallback; }
  ...
  void Send_SetZoom_ToView(void (T::*pCallback)(double nZoom, const POINT *pPoint)) { mpCallback_SetZoom = pCallback; }
  ...
  void Send_GetGridLock_ToView(bool (T::*pCallback)(void) const) { mpCallback_GetGridLock = pCallback; }
  ...
  void Send_GetMouseTolerance_ToView(long (T::*pCallback)(void) const) { mpCallback_GetMouseTolerance = pCallback; }
  ...
  void Send_GetMinimumDistance_ToView(double (T::*pCallback)(void) const) { mpCallback_GetMinimumDistance = pCallback; }
