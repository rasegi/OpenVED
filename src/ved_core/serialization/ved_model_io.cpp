...
bool VEDModelWriteResult::Ok() const noexcept { return error == VEDBinaryError::None; }

bool VEDModelReadResult::Ok() const noexcept { return error == VEDBinaryError::None && model != nullptr; }

VEDModelWriteResult SaveVecModelToBytes(const TDVecModel &model) { return SaveVecModelToBytes(model, {}); }
