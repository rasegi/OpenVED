...
class TDVecPolygonArea : public TDVecObject {
public:
    TDVecPolygonArea();
    TDVecPolygonArea(const TDVecPolygonArea&) = default;
    TDVecPolygonArea& operator=(const TDVecPolygonArea&) = default;
    ...
    static std::unique_ptr<TDVecPolygonArea> ReadFrom(VEDBinaryReader& reader);
