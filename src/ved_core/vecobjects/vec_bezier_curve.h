...
class TDVecBezierCurve : public TDVecObject {
public:
    TDVecBezierCurve();
    TDVecBezierCurve(const TDVecBezierCurve&) = default;
    TDVecBezierCurve& operator=(const TDVecBezierCurve&) = default;
    ...
    static std::unique_ptr<TDVecBezierCurve> ReadFrom(VEDBinaryReader& reader);
