...
extern const double
    MAX_NEGATIV_REAL_VALUE; // Wenn ein negativer Wert diesen  überschreitet, wird sie als 0.0 interpretiert.
extern const double
    MIN_POSITIV_REAL_VALUE; // Wenn ein positiver Wert diesen unterschreitet, wird sie als 0.0 interpretiert.
...
enum TDGEScrollType { GE_SB_HORZ = 0, GE_SB_VERT = 1, GE_SB_CTL = 2, GE_SB_BOTH = 3 };
